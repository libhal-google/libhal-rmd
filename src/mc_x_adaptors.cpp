...
#include <libhal-rmd/mc_x_motor.hpp>
#include <libhal-rmd/mc_x_rotation_sensor.hpp>
#include <libhal-rmd/mc_x_servo.hpp>
#include <libhal-rmd/mc_x_temperature_sensor.hpp>
